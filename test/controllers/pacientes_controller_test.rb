...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference("Paciente.count") do
      post pacientes_url, params: { paciente: { birthday: @paciente.birthday, cpf: @paciente.cpf, email: @paciente.email, name: @paciente.name } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { birthday: @paciente.birthday, cpf: @paciente.cpf, email: @paciente.email, name: @paciente.name } }
